  ...
  return (
    <section className="relative min-h-screen copa-gradient-hero overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute -right-1/4 -top-1/4 w-3/4 h-3/4 bg-accent/10 rounded-full blur-3xl" />
      </div>
      ...
      <div className="container mx-auto px-8 py-12 relative z-10">
        ...
        <div className="max-w-2xl pt-20 md:pt-24">
          ...
          <p
            className="text-xl md:text-2xl font-light text-white/80 animate-fade-in mb-8"
