...
import { Layers, Settings, Droplets, Building2, Flame, Award, Thermometer, Zap } from "lucide-react";
    ...
    <section id="pillar-solution" className="section-padding bg-muted/30">
      <div className="container-wide">
        ...
        <div className="bg-card rounded-2xl p-8 md:p-12 mb-16 shadow-lg border border-border">
          ...
          <div className="relative max-w-4xl mx-auto">
            ...
            <div className="bg-gradient-to-b from-stone-400 to-stone-500 rounded-t-xl h-16 md:h-20 flex items-center justify-center shadow-lg">
              <span className="text-white font-semibold text-lg">{t("pillar.stoneSurface")}</span>
            </div>
            ...
            <div className="text-center mt-4">
              <span className="text-accent font-medium">{t("pillar.toHeatPump")}</span>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6 mt-8">
            <div className="text-center p-4 bg-muted/50 rounded-lg">
              <div className="text-accent font-semibold text-xl mb-1">{t("pillar.stainlessSteel")}</div>
              <p className="text-muted-foreground text-sm">{t("pillar.stainlessSteelDesc")}</p>
            </div>
            <div className="text-center p-4 bg-muted/50 rounded-lg">
              <div className="text-accent font-semibold text-xl mb-1">{t("pillar.thermalBond")}</div>
              <p className="text-muted-foreground text-sm">{t("pillar.thermalBondDesc")}</p>
            </div>
            <div className="text-center p-4 bg-muted/50 rounded-lg">
              <div className="text-accent font-semibold text-xl mb-1">{t("pillar.glycolCircuit")}</div>
              <p className="text-muted-foreground text-sm">{t("pillar.glycolCircuitDesc")}</p>
            </div>
          </div>
        </div>
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-card rounded-xl p-5 shadow-md border border-border text-center">
                <div className="text-accent font-semibold text-2xl mb-1">{t("pillar.bcSeries.title")}</div>
                <div className="text-muted-foreground text-sm">{t("pillar.bcSeries.subtitle")}</div>
                <p className="text-muted-foreground text-xs mt-2">{t("pillar.bcSeries.description")}</p>
              </div>
              <div className="bg-card rounded-xl p-5 shadow-md border border-border text-center">
                <div className="text-accent font-semibold text-2xl mb-1">{t("pillar.uBrs.title")}</div>
                <div className="text-muted-foreground text-sm">{t("pillar.uBrs.subtitle")}</div>
                <p className="text-muted-foreground text-xs mt-2">{t("pillar.uBrs.description")}</p>
              </div>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="md:col-span-2 grid sm:grid-cols-2 gap-6">
              <div className="bg-primary-foreground/10 backdrop-blur-sm rounded-xl p-6 border border-primary-foreground/20">
                <div className="text-accent font-semibold text-3xl mb-2">1,480</div>
                <div className="text-primary-foreground font-medium mb-1">{t("pillar.integration.annual")}</div>
                <p className="text-primary-foreground/70 text-sm">
                  {t("pillar.integration.annualDesc")}
                </p>
              </div>
              <div className="bg-primary-foreground/10 backdrop-blur-sm rounded-xl p-6 border border-primary-foreground/20">
                <div className="text-accent font-semibold text-3xl mb-2">18-955mm</div>
                <div className="text-primary-foreground font-medium mb-1">{t("pillar.integration.heightRange")}</div>
                <p className="text-primary-foreground/70 text-sm">
                  {t("pillar.integration.heightRangeDesc")}
                </p>
              </div>
              <div className="bg-primary-foreground/10 backdrop-blur-sm rounded-xl p-6 border border-primary-foreground/20">
                <div className="text-accent font-semibold text-3xl mb-2">1,000kg</div>
                <div className="text-primary-foreground font-medium mb-1">{t("pillar.integration.loadCapacity")}</div>
                <p className="text-primary-foreground/70 text-sm">
                  {t("pillar.integration.loadCapacityDesc")}
                </p>
              </div>
              <div className="bg-primary-foreground/10 backdrop-blur-sm rounded-xl p-6 border border-primary-foreground/20">
                <div className="text-accent font-semibold text-3xl mb-2">25+</div>
                <div className="text-primary-foreground font-medium mb-1">{t("pillar.integration.lifespan")}</div>
                <p className="text-primary-foreground/70 text-sm">
        ...
        <div className="mt-16 text-center">
          <p className="text-muted-foreground text-sm mb-4">{t("pillar.trusted")}</p>
