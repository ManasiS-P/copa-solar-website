          ...
          >
            ...
            <div className="space-y-2 mb-4">
              <div className="flex justify-between py-2 border-b border-border/50">
                <span className="text-muted-foreground">
                  {t("epd.manufacturer", "Manufacturer")}
                </span>
              ...
              <div className="flex justify-between py-2 border-b border-border/50">
                <span className="text-muted-foreground">
                  {t("epd.declaredUnit", "Declared Unit")}
                </span>
                <span className="text-foreground font-medium">
                  1 m² (2.48 kg)
                </span>
              ...
              <div className="flex justify-between py-2 border-b border-border/50">
                <span className="text-muted-foreground">
                  {t("epd.productionLocation", "Production Location")}
                </span>
                <span className="text-foreground font-medium">
                  SSAB Braunschweig, Germany
                </span>
              </div>
              <div className="flex justify-between py-2 border-b border-border/50">
                <span className="text-muted-foreground">
                  {t("epd.referenceStandard", "Reference Standard")}
                </span>
                <span className="text-foreground font-medium">
                  EN 15804+A2:2019
                </span>
              ...
              <div className="flex justify-between py-2 border-b border-border/50">
                ...
                <span className="text-foreground font-medium">
                  {t("epd.scopeValue", "Cradle to gate (C1-C4, D)")}
                </span>
              </div>
              <div className="flex justify-between py-2">
                <span className="text-muted-foreground">
                  {t("epd.verification", "Verification")}
                </span>
                <span className="text-foreground font-medium">
                  {t("epd.verificationValue", "Third-party verified")}
                </span>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <Button asChild className="flex-1">
                <a
                  href="/documents/EPD_Copa_Solar_Retrofit_Thermal_Absorber.pdf"
                  download
                >
            ...
            <div className="bg-secondary/10 rounded-lg p-4 border border-secondary/20">
              <p className="text-foreground text-sm leading-relaxed">
                <strong className="text-secondary">
                  {t("epd.circularEconomy")}:
                </strong>{" "}
                {t("epd.circularDescription")}
              </p>
            </div>
          </motion.div>
        </div>
            ...
            <div className="grid md:grid-cols-3 gap-6 items-center">
              ...
              <div className="md:col-span-2 grid sm:grid-cols-3 gap-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-muted-foreground text-sm">
                      {t("epd.certification", "Certification")}
                    </p>
                    <p className="text-foreground font-semibold">
                      ISO 9001:2015
                    </p>
                    <p className="text-muted-foreground text-xs mt-1">
                      {t("epd.qualityManagement", "Quality Management System")}
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-muted-foreground text-sm">
                      {t("epd.certifiedCompany", "Certified Company")}
                    </p>
                    <p className="text-foreground font-semibold">
                      Copa Solar AB
                    </p>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-muted-foreground text-sm">
                      {t("epd.certifiedSince", "Certified Since")}
                    </p>
                    <p className="text-foreground font-semibold">
                      5 August 2024
                    </p>
                    <p className="text-muted-foreground text-xs mt-1">
                      {t("epd.certifiedBy", "Certified by A3CERT")}
                    </p>
                  </div>
                </div>
              </div>
