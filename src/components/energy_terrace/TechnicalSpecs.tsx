...
const TechnicalSpecs = () => {
  ...
  // 🚨 THE FINAL FIX: We remove the "as string[]" forcing!
  const translatedFeatures = t("specs.absorber.features", {
    returnObjects: true,
  });

  // If translatedFeatures is an array, use it. Otherwise, use the hardcoded backup.
  const absorberFeatures = Array.isArray(translatedFeatures)
    ? translatedFeatures
    : [
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            ...
            <div className="relative">
              <img
                ...
                alt="Stainless steel solar absorber core"
