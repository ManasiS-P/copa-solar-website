...
const Applications = () => {
  ...
  const savings = [
    {
      category: t("applications.economy.hotWater.title"),
      value: ">30%",
      description: t("applications.economy.hotWater.description"),
    },
    {
      category: t("applications.economy.heating.title"),
      value: ">40%",
      description: t("applications.economy.heating.description"),
    },
    {
      category: t("applications.economy.cooling.title"),
      value: ">35%",
      description: t("applications.economy.cooling.description"),
    },
    {
      category: t("applications.economy.coolingDemand.title"),
      value: ">40%",
      description: t("applications.economy.coolingDemand.description"),
    },
  ];
